...
function indekseGoreFenomen(feno, indeks) {
  let x = indeks + '. indekste bulunan fenomen: ' + feno[indeks].profile;
  return x;
}
...
function fenomenSil(feno, indeks_Sayi) {
  let yeniDizi =[...feno];
  yeniDizi.shift(indeks_Sayi);
  return yeniDizi;
}
...
function fenomenEkle(feno, sayi, profil, takipci, gönderi, medya) {
  ...
  yeniHesap.posts=gönderi;
  yeniHesap.platform=medya;

  yeniDizi.push(yeniHesap);
  return yeniDizi;
}
